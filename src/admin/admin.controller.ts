...
export class AdminController {
  ...
  @ApiOperation({
    summary: 'Approve an author suggestion and create a new author',
  })
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'ID of the author suggestion to approve',
  })
  @ApiResponse({
    status: 200,
    description: 'Author suggestion approved and new author created',
  })
  ...
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'ID of the author suggestion to reject',
  })
